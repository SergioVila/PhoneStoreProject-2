            ...
            <div class="container">
                <ul class="navlinks">
                    ...
                    <li style="float: right;list-style-type: none">
                        ...
                        %>
                        <a id="modal_trigger" href="#myPopupEditUser" data-rel="popup">Click here to Login or register</a>

                        <!--    popup appears once login is selected     -->
                        <div data-role="popup" id="myPopupEditUser" class="ui-content" style="min-width:250px;">
