            ...
            <div class="container">
                <ul class="navlinks">
                    ...
                    <li style="float: right;list-style-type: none">
                        ...
                        %>
                        <a id="modal_trigger" href="#myPopupAddSupplier" data-rel="popup">Click here to Login or register</a>

                        <!--    popup appears once login is selected     -->
                        <div data-role="popup" id="myPopupAddSupplier" class="ui-content" style="min-width:250px;">
            ...
            <div class="container">
                <form method="post" action="processRequest">
                    <div class="container-fluid" style="width: 500px">
                        <label>Supplier Name:</label><input type="text" name="supplierName" id = "supplierName" placeholder="supplierName"> 
                        <label>Supplier Email:</label><input type="text" name="supplierEmail" id = "supplierEmail" placeholder="supplierEmail" > 
                        <label>Supplier Address:</label><input type="text" name="supplierAddress" id = "supplierAddress" placeholder="supplierAddress" > 
                        <label>Supplier County:</label><input type="text" name="supplierCounty" id = "supplierCounty" placeholder="supplierCounty" > 
                        <label>Supplier Country:</label><input type="text" name="supplierCountry" id = "supplierCountry" placeholder="supplierCountry" > 
                        <label>Supplier Phone:</label><input type="text" name="supplierPhone" id = "supplierPhone" placeholder="supplierPhone" > 

                        <input type="hidden" value="RegisterNewSupplier" name="action">
